(custom-set-variables
 ...
 '(package-selected-packages
   '(mozc hide-mode-line org-tree-slide figlet org-present auctex srcery-theme parse-csv edit-indirect image-dired+ ranger dired-ranger terminal-here projectile zone-nyan nyan-mode selectric-mode landmark fireplace parrot volume easy-hugo htmlize swiper-helm helm-swiper selectrum-prescient selectrum evil-magit evil-org evil-collection amx bug-hunter org-bullets focus smartparens ewal-doom-themes ewal olivetti writeroom-mode heaven-and-hell doom-themes all-the-icons-ivy-rich ivy-rich all-the-icons-ivy all-the-icons-dired neotree rainbow-mode markdown-mode magit yasnippet ivy-prescient counsel ivy helm which-key evil doom-modeline use-package))
