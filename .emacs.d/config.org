...
#+end_src
* Spaceline
Another cool modeline for emacs. Spaceline it's the default modeline for spacemacs. It has a lot more of eye candy and powerline separators. It seems to be more resource intensive to , but I'm not entirely sure. It's very usefull when using EXWM since doom has some issues.
#+begin_src emacs-lisp
