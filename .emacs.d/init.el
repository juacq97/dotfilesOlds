...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dired-hide-dotfiles dired-open all-the-icons-dired openwith ranger dired-ranger org-super-agenda calfw calfw-org figlet company lua luarocks lua-mode org-superstar org-tree-slide ox-pandoc terminal-here easy-hugo rainbow-delimiters smartparens ewal-doom-themes ewal writeroom-mode heaven-and-hell doom-themes rainbow-mode markdown-mode yasnippet all-the-icons-ivy-rich counsel ivy-prescient ivy-rich ivy which-key doom-modeline evil-magit evil-org evil-collection evil use-package)))
(custom-set-faces
