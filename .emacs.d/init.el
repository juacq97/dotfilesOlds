...
;; El parrafo enfocado es mas brillante que el resto
(use-package focus
  :ensure t)
...
;; Encabezados y listas más vistosas
...
;; COnfiguraciones para la agenda
...
;; Keybinding para almacenar un link
(global-set-key (kbd "C-c l") 'org-store-link)

;; Keybinding para llamar a org-capture
...
;; Soporte para marcar con shift (emacs state)
...
; Configuraciones de fuentes extras (para usar fuentes proporcionales)
...
(defalias 'yes-or-no-p 'y-or-n-p) ; pregunta y o n

(setq scroll-conservatively 100) ; movimiento sano

(global-hl-line-mode t) ; resaltar linea actual
...
(global-set-key (kbd "C-x k") 'kill-current-buffer) ; matar buffer
...
;; Define el modo para diferentes fuentes
