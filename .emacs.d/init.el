...
(custom-set-faces
 ...
 '(highlight ((t nil)))
 '(hl-line ((t (:background "#422E3C"))))
 '(ivy-current-match ((t (:inherit bold :background "dark slate blue"))))
 '(ivy-prompt-match ((t (:background "red"))))
 '(line-number ((t (:foreground "#a68ea3"))))
