...
(use-package heaven-and-hell
  ...
  (setq heaven-and-hell-themes
        '((light . tango)
          (dark . ewal-spacemacs-modern))) ;; Themes can be the list: (dark . (tsdh-dark wombat))
;          (dark . doom-dracula))) ;; Themes can be the list: (dark . (tsdh-dark wombat))
...
(custom-set-faces
 ...
 '(mode-line ((t (:foreground "#e4c6a4" :box nil))))
