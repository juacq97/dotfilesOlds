...
static char *font = "FantasqueSansMono Nerd Font Mono:pixelsize=13:antialias=true:autohint=true, Font Awesome 5 Free:pixelsize=13:antialias=true:autohint=true";
